...
[Read the full documentation at the plugin website](https://www.paidmembershipspro.com/add-ons/pmpro-courses-lms-integration/).
...
1. Upload the `pmpro-courses` directory to the `/wp-content/plugins/` directory of your site.
